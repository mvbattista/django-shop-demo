...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'wp8yGVwqzYSX643YPBaN9rjoatSGGS9n9Ngq2OUM8Ivs8mQrcVHsja8QE0wXdVyq')
...
STATICFILES_FINDERS = [
    'giftshop.finders.FileSystemFinder',  # or 'django.contrib.staticfiles.finders.FileSystemFinder',
    'giftshop.finders.AppDirectoriesFinder',  # or 'django.contrib.staticfiles.finders.AppDirectoriesFinder',
...
CMS_TEMPLATES = [
    ('giftshop/pages/default.html', _("Default Page")),
    ('giftshop/pages/test.html', _("Test Page")),  # to show strides rendering via {% render_cascade ... %}
]
...
CMSPLUGIN_CASCADE = {
    ...
    'plugins_with_extra_render_templates': {
        'CustomSnippetPlugin': [
            ...
            ('giftshop/catalog/manufacturer-filter.html', _("Manufacturer Filter")),
        ],
        # required to purchase real estate
        'ShopAddToCartPlugin': [
            (None, _("Default")),
            ('giftshop/catalog/commodity-add2cart.html', _("Add Commodity to Cart")),
        ],
    },
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'INDEX_NAME': 'giftshop-en',
    },
    'de': {
        'ENGINE': 'haystack.backends.elasticsearch_backend.ElasticsearchSearchEngine',
        'URL': 'http://{}:9200/'.format(ELASTICSEARCH_HOST),
        'INDEX_NAME': 'giftshop-de',
    }
}
...
SHOP_CART_MODIFIERS = [
    'giftshop.modifiers.PrimaryCartModifier',
...
SHOP_CASCADE_FORMS = {
    'CustomerForm': 'giftshop.forms.CustomerForm',
}
